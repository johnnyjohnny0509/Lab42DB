package com.example.taruc.lab42db;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserViewHolder> {
    ...
    public class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        //itemview = the layout to display each record
    ...
    //context = the app that is hosting a recycleview
    ...
    public void setUsers(List<User> users){
        userList = users;
        notifyDataSetChanged(); // inform viewmode1 of any data change
    }
}
